...
AudioConnection          patchCord35(d3606BandPass, 1, d3606AmpEnv, 0);
AudioConnection          patchCord36(clapDelay1, 0, clapMixer1, 0);
AudioConnection          patchCord37(clapDelay1, 1, clapMixer1, 1);
AudioConnection          patchCord38(clapDelay1, 2, clapMixer1, 2);
AudioConnection          patchCord39(clapDelay1, 3, clapMixer1, 3);
AudioConnection          patchCord40(clapDelay2, 0, clapMixer2, 0);
AudioConnection          patchCord41(clapDelay2, 1, clapMixer2, 1);
AudioConnection          patchCord42(clapDelay2, 2, clapMixer2, 2);
AudioConnection          patchCord43(clapDelay2, 3, clapMixer2, 3);
AudioConnection          patchCord44(d3Perc, 0, d3VoiceMixer, 2);
AudioConnection          patchCord45(d1AmpEnv, 0, d1LowPass, 0);
AudioConnection          patchCord46(d1AmpEnv, 0, masterWfInputMixer, 2);
AudioConnection          patchCord47(d3FmHighPass, 2, d3FmAmpEnv, 0);
AudioConnection          patchCord48(d2AmpEnv, 0, d2VoiceMixer, 0);
AudioConnection          patchCord49(d2AmpEnv, 0, masterWfInputMixer, 3);
AudioConnection          patchCord50(d3FmAmpEnv, 0, d3VoiceMixer, 1);
AudioConnection          patchCord51(d2ClickTransient, 0, d2ClickFilter, 0);
AudioConnection          patchCord52(clapMixer1, 0, clapBusMixer, 0);
AudioConnection          patchCord53(clapMixer2, 0, clapBusMixer, 1);
AudioConnection          patchCord54(d1LowPass, 0, d1Wavefolder, 0);
AudioConnection          patchCord55(d1LowPass, 0, d1VoiceMixer, 0);
AudioConnection          patchCord56(d3606AmpEnv, 0, d3VoiceMixer, 0);
AudioConnection          patchCord57(d2NoiseFilter, 2, d2VoiceMixer, 2);
AudioConnection          patchCord58(d2Body, 0, d2VoiceMixer, 1);
AudioConnection          patchCord59(d2ClickFilter, 1, d2VoiceMixer, 3);
AudioConnection          patchCord60(clapBusMixer, 0, clapMasterFilter, 0);
AudioConnection          patchCord61(d1Snap, d1SnapAmp);
AudioConnection          patchCord62(d1WfDrive, 0, d1Wavefolder, 1);
AudioConnection          patchCord63(d3VoiceMixer, 0, d3Wavefolder, 0);
AudioConnection          patchCord64(d3VoiceMixer, 0, d3MasterMixer, 0);
AudioConnection          patchCord65(d3WfOsc, 0, d3Wavefolder, 1);
AudioConnection          patchCord66(d2VoiceMixer, 0, d2VoiceHighPass, 0);
AudioConnection          patchCord67(clapAmp, clapMasterEnv);
AudioConnection          patchCord68(clapMasterFilter, 2, clapAmp, 0);
AudioConnection          patchCord69(d1SnapAmp, 0, d1VoiceMixer, 1);
AudioConnection          patchCord70(d2WfSineOsc, d2WfAmp);
AudioConnection          patchCord71(clapMasterEnv, 0, snareClapMixer, 1);
AudioConnection          patchCord72(d1Wavefolder, 0, d1VoiceMixer, 3);
AudioConnection          patchCord73(d2VoiceHighPass, 2, snareClapMixer, 0);
AudioConnection          patchCord74(d3Wavefolder, 0, d3MasterMixer, 1);
AudioConnection          patchCord75(d2Reverb, 0, d2MasterMixer, 1);
AudioConnection          patchCord76(d2WfAmp, 0, d2Wavefolder, 1);
AudioConnection          patchCord77(d1VoiceMixer, 0, d1HighPass, 0);
AudioConnection          patchCord78(snareClapMixer, 0, d2MasterMixer, 0);
AudioConnection          patchCord79(snareClapMixer, d2Reverb);
AudioConnection          patchCord80(snareClapMixer, 0, d2Wavefolder, 0);
AudioConnection          patchCord81(snareClapMixer, 0, delaySendMixer, 1);
...
AudioConnection          patchCord85(d1HighPass, 2, d1EQ, 0);
AudioConnection          patchCord86(d2WfLowPass, 0, d2MasterMixer, 2);
AudioConnection          patchCord87(d1EQ, d1Amp);
AudioConnection          patchCord88(masterWfOscSine, 0, masterWfInputMixer, 0);
AudioConnection          patchCord89(masterWfOscSaw, 0, masterWfInputMixer, 1);
AudioConnection          patchCord90(drumMixer, 0, masterMixer, 0);
AudioConnection          patchCord91(drumMixer, 0, masterWavefolder, 0);
AudioConnection          patchCord92(d3MasterFilter, 0, drumMixer, 2);
AudioConnection          patchCord93(d3MasterFilter, 0, delaySendMixer, 2);
AudioConnection          patchCord94(masterWfInputMixer, 0, masterWavefolder, 1);
AudioConnection          patchCord95(d1Amp, 0, drumMixer, 0);
AudioConnection          patchCord96(d1Amp, 0, delaySendMixer, 0);
...
AudioConnection          patchCord102(delayFilter, 0, delaySendMixer, 3);
AudioConnection          patchCord103(delaySendMixer, masterDelay);
AudioConnection          patchCord104(delayFilter, 0, delayAmp, 0);
AudioConnection          patchCord105(masterHighPass, 2, masterLowPass, 0);
AudioConnection          patchCord106(masterLowPass, 0, masterBandPass, 0);
AudioConnection          patchCord107(masterBandPass, 1, masterVolume, 0);
AudioConnection          patchCord108(masterVolume, finalFilter);
